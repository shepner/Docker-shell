...
This is mainly to aid prototyping.

To run:
``` shell
sudo docker run -it shepner/shell
```
...
usage: apk COMMAND [-h|--help] [-p|--root DIR] [-X|--repository REPO]
           ...
           [-f|--force] [--force-binary-stdout] [--force-broken-world]
           ...
           [--cache-max-age AGE] [--arch ARCH] [--print-arch] [ARGS]...
